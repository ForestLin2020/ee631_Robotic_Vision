...
image = cv2.imread('reference.jpg', 0) # (756,495)
...
while True:
    ...
    if len(good_points) > 10:
        ...
        homography = cv2.polylines(frame, [np.int32(distort_pts)], True, (0, 255, 0), 3)

        cv2.imshow('Live demo of object detection - Good Matching', homography)
    else:
        cv2.imshow('Live demo of object detection - Poor Matching',grayframe)
