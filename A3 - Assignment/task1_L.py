...
print('Intrinsic  parameters from Left = ',mtx)
print('Distortion parameters from Left = ',dist)
...
# save parameters
np.save('L_intrinsic  parameters.npy', mtx)
np.save('L_distortion parameters.npy', dist)
