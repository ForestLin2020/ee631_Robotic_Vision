...
print('Intrinsic  parameters from Right = ',mtx)
print('Distortion parameters from Right = ',dist)

# Calculate the actual focal length
# fsx = mtx[0,0]
# print('fsx = ', fsx)
# focal_length = fsx * 7.4e-6 * 1000
# print('focal_length in mm = {} mm'.format(focal_length))

# save parameters
np.save('R_intrinsic  parameters.npy', mtx)
np.save('R_distortion parameters.npy', dist)
